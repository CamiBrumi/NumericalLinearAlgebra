...
int sistema_1lu(double **lua, double x[], double ei[], int n, int perm){ //ara la x serà cada una de les columnes de la inversa
	...
	//Ara hem de resoldre n sistemes lineals per a fer la inversa
    
    resol(lu, x, ei, n, perm);
